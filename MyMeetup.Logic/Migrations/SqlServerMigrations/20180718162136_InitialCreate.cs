    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2018, 7, 18, 16, 21, 36, 360, DateTimeKind.Utc), "Rencontres Non Scolarisees", new DateTime(2018, 7, 18, 16, 21, 36, 360, DateTimeKind.Utc) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Animaux", "<ul><li>Les chiens sont tolérés, à condition qu'ils restent attachés ou auprès de vous en permanence.</li><li>Ils ne doivent également pas être bruyants.</li></ul>", new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc), true, null, 1, new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc) },
                    { 2, "Alcool", "<ul><li>La consommation d’alcool doit être raisonnée, pour toutes les personnes participantes, quel que soit leur âge, et bien sûr, les parents ou les référents sont invités à être attentifs à cette problématique vis-à-vis des personnes dont ils sont responsables.</li></ul>", new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc), true, null, 2, new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                <div>Ce document servira &agrave; partager toutes les infos sur la rencontre (logements, covoiturage, activit&eacute;s,&hellip;)</div>", new DateTime(2018, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "La Taillade 2018", "La-Taillade.jpg", new DateTime(2018, 7, 18, 16, 21, 36, 357, DateTimeKind.Utc) },
                    { 2, new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc), new DateTime(2019, 3, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "Rencontre près de Casteljaloux(47) du 22 au 29 octobre 2018. Situé dans un écrin de forêt, les hébergements se répartissent entre gîtes, landettes, emplacements pour tentes et camions, et quelques yourtes.", @"<div><strong>Toutes les inscriptions (locatif ou camping) doivent se faire uniquement par mail &agrave; : francois.fonseca@solincite.org</strong></div>
                <div>Vous devrez lui indiquer vos&nbsp;<strong>noms/pr&eacute;noms/adresse postale/nb d&rsquo;adultes+d&rsquo;enfants.</strong></div>
                <div><strong>Il n&rsquo;y a qu&rsquo;un seul interlocuteur par logement : un logement est r&eacute;serv&eacute; par une seule famille, c&rsquo;est elle qui fait la r&eacute;servation et paiera la somme totale au village de vacances. </strong>Vous pouvez donc r&eacute;server &agrave; votre nom et trouver d&rsquo;autres familles pour partager, gr&acirc;ce au document Pad mis &agrave; disposition <strong>:&nbsp;</strong><strong><a href=""https://semestriel.framapad.org/p/LaTaillade_qfmnV6VC4B"">https://semestriel.framapad.org/p/LaTaillade_qfmnV6VC4B</a></strong></div>
                <div>Ce document servira &agrave; partager toutes les infos sur la rencontre (logements, covoiturage, activit&eacute;s,&hellip;)</div>", new DateTime(2019, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "La Taillade Printemps 2019", "La-Taillade.jpg", new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc) }
                });

            migrationBuilder.InsertData(
                table: "ContenusChartes",
                columns: new[] { "Id", "Category", "Content", "CreatedAt", "IsActive", "MeetupId", "Position", "UpdatedAt" },
                values: new object[] { 3, "Spécifique à la Taillade", "<ul><li>La tradition est née de faire des trous autour du barbecue, il est important de les reboucher au départ des enfants</li></ul>", new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc), true, 1, 1, new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc) });
