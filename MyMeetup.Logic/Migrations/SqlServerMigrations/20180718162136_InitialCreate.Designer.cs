...
namespace MyMeetUp.Logic.Migrations.SqlServerMigrations
{
    ...
    [Migration("20180718162136_InitialCreate")]
            ...
            modelBuilder.Entity("MyMeetUp.Logic.Models.AppParameter", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 360, DateTimeKind.Utc), Title = "Rencontres Non Scolarisees", UpdatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 360, DateTimeKind.Utc) }
                    );
                });
            ...
            modelBuilder.Entity("MyMeetUp.Logic.Models.CharterContent", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Category = "Animaux", Content = "<ul><li>Les chiens sont tolérés, à condition qu'ils restent attachés ou auprès de vous en permanence.</li><li>Ils ne doivent également pas être bruyants.</li></ul>", CreatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc), IsActive = true, Position = 1, UpdatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc) },
                        new { Id = 2, Category = "Alcool", Content = "<ul><li>La consommation d’alcool doit être raisonnée, pour toutes les personnes participantes, quel que soit leur âge, et bien sûr, les parents ou les référents sont invités à être attentifs à cette problématique vis-à-vis des personnes dont ils sont responsables.</li></ul>", CreatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc), IsActive = true, Position = 2, UpdatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc) },
                        new { Id = 3, Category = "Spécifique à la Taillade", Content = "<ul><li>La tradition est née de faire des trous autour du barbecue, il est important de les reboucher au départ des enfants</li></ul>", CreatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc), IsActive = true, MeetupId = 1, Position = 1, UpdatedAt = new DateTime(2018, 7, 18, 16, 21, 36, 358, DateTimeKind.Utc) }
                    );
                });
